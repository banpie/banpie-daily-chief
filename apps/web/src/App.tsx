...
export default function App() {
  ...
  if (loading) return <div className="splash"><div className="brand-mark">参</div><p>正在读取本地工作台…</p></div>;
  if (error) return <div className="splash error"><h1>无法打开工作台</h1><p>{error}</p><small>请从 daily-chief serve 输出的完整本地链接重新进入。</small></div>;
